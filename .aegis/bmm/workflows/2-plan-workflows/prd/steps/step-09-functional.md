...
- Load `{project-root}/{aegis_folder}/bmm/workflows/2-plan-workflows/prd/steps/step-10-nonfunctional.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/{aegis_folder}/bmm/workflows/2-plan-workflows/prd/steps/step-10-nonfunctional.md` to define non-functional requirements.
