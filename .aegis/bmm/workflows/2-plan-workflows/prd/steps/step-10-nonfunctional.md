...
- Load `{project-root}/{aegis_folder}/bmm/workflows/2-plan-workflows/prd/steps/step-11-complete.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/{aegis_folder}/bmm/workflows/2-plan-workflows/prd/steps/step-11-complete.md` to finalize the PRD and complete the workflow.
