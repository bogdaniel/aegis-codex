...
simple_architecture: '{project-root}/{aegis_folder}/bmb/docs/agents/simple-agent-architecture.md'
expert_architecture: '{project-root}/{aegis_folder}/bmb/docs/agents/expert-agent-architecture.md'
module_architecture: '{project-root}/{aegis_folder}/bmb/docs/agents/module-agent-architecture.md'
menu_patterns: '{project-root}/{aegis_folder}/bmb/docs/agents/agent-menu-patterns.md'
communication_presets: '{project-root}/{aegis_folder}/bmb/workflows/create-agent/data/communication-presets.csv'
reference_simple_agent: '{project-root}/{aegis_folder}/bmb/reference/agents/simple-examples/commit-poet.agent.yaml'
reference_expert_agent: '{project-root}/{aegis_folder}/bmb/reference/agents/expert-examples/journal-keeper/journal-keeper.agent.yaml'
validation: '{project-root}/{aegis_folder}/bmb/workflows/create-agent/data/agent-validation-checklist.md'
---
