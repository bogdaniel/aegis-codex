...
- `{project-root}/{aegis_folder}/bmb/docs/workflows/templates/step-template.md`
- `{project-root}/{aegis_folder}/bmb/docs/workflows/templates/workflow-template.md`
- `{project-root}/{aegis_folder}/bmb/docs/workflows/architecture.md`
