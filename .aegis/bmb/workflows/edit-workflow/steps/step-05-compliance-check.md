...
# Path Definitions
workflow_path: '{project-root}/{aegis_folder}/bmb/workflows/edit-workflow'

# File References
thisStepFile: '{workflow_path}/steps/step-05-compliance-check.md'
workflowFile: '{workflow_path}/workflow.md'
editedWorkflowPath: '{target_workflow_path}'
complianceCheckWorkflow: '{project-root}/{aegis_folder}/bmb/workflows/workflow-compliance-check/workflow.md'
outputFile: '{output_folder}/workflow-edit-{target_workflow_name}.md'

# Task References
complianceCheckTask: '{project-root}/{aegis_folder}/bmb/workflows/workflow-compliance-check/workflow.md'
---
