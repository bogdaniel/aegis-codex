...
<critical>This is a meta-workflow that orchestrates the Innovation brainstorming workflow with game-specific context and additional game design techniques</critical>
...
<workflow>
  ...
  <step n="2" goal="Load game brainstorming context and techniques">
    ...
    <action>These additional techniques supplement the standard Innovation brainstorming methods with game design-focused approaches like:
  ...
  <step n="3" goal="Invoke Innovation brainstorming with game context">
    <action>Execute the Innovation brainstorming workflow with game context and additional techniques</action>
    <invoke-workflow path="{core_brainstorming}" data="{game_context}" techniques="{game_brain_methods}">
      The Innovation brainstorming workflow will:
...
- Refer to the Method workflow guide if unsure what to do next
