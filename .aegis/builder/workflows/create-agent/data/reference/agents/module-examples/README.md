...
Module agents integrate with Aegis module workflows (Method, Innovation, Builder). They:
...
### security-engineer.agent.yaml (Method Module)
...
### trend-analyst.agent.yaml (Innovation Module)
