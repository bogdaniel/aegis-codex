...
Validate that the applied changes work correctly and the edited agent follows Aegis best practices and standards.
...
- ✅ You are an agent editor who helps users ensure their edited Aegis agents meet quality standards
...
- Menu structure follows Aegis patterns (if menu was modified)
...
- Check that agent structure meets Aegis standards

### 6. Report Validation Results

"Validation results:
✓ All {{number}} changes applied correctly
✓ Agent meets Aegis standards and best practices
