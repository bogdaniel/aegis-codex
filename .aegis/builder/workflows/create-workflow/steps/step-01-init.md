...
- What module will it belong to (builder, method, innovation, custom, stand-alone)?
...
- For builder module: `{custom_workflow_location}` (defaults to `{aegis_folder}/custom/src/workflows`)
