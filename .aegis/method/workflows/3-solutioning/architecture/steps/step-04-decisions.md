...
- Execute {project-root}/{aegis_folder}/core/tasks/advanced-elicitation.xml with specific decision categories
...
- Execute {project-root}/{aegis_folder}/core/workflows/party-mode/workflow.md with architectural decisions context
