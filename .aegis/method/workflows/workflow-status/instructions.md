...
<critical>You MUST have already loaded and processed: {project-root}/{aegis_folder}/method/workflows/workflow-status/workflow.yaml</critical>
...
<action>Search {output_folder}/ for file: method-workflow-status.yaml</action>
...
<check if="no status file found">
  ...
  <check if="response == y OR response == yes">
    ...
    <invoke-workflow path="{project-root}/{aegis_folder}/method/workflows/workflow-status/init/workflow.yaml"></invoke-workflow>
...
<action>Read method-workflow-status.yaml</action>
...
<check if="choice == 3">
  <action>Display complete method-workflow-status.yaml file contents</action>
</check>
...
<action>Read {output_folder}/method-workflow-status.yaml if exists</action>
...
<template-output>status_file_path = {{path to method-workflow-status.yaml}}</template-output>
</check>
...
<action>Read {output_folder}/method-workflow-status.yaml</action>
