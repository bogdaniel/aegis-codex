...
- Method artifacts: PRD, epics, architecture, UX, brief, research, brainstorm
...
- LEGACY: Has code but no Method artifacts
...
To check progress: Load any Method agent and run /aegis:method:workflows:workflow-status
...
For game development, install the GameDev module:
