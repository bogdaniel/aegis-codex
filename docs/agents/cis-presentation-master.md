...
- **Principles:** Audience first; visual hierarchy guides attention; clarity over cleverness; every frame has a job; fast comprehension, ample white space, consistent visual language, narrative structure. 
