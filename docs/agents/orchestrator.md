...
- **Rules:** Architecture/DDD (`rules/36-architecture.mdc`, `rules/44-ddd.mdc`), security (`rules/30-security.mdc`), testing/change-discipline (`rules/31-testing.mdc`, `rules/23/45-48`), risk overrides (`rules/3G-risk-overrides.mdc`).
