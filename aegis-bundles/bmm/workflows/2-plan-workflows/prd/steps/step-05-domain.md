...
If NO to these questions, skip this step and load `{project-root}/{aegis_folder}/bmm/workflows/2-plan-workflows/prd/steps/step-06-innovation.md`.
...
- Load `{project-root}/{aegis_folder}/bmm/workflows/2-plan-workflows/prd/domain-complexity.csv` completely
...
- Load `{project-root}/{aegis_folder}/bmm/workflows/2-plan-workflows/prd/steps/step-06-innovation.md`
...
Skip this step and load `{project-root}/{aegis_folder}/bmm/workflows/2-plan-workflows/prd/steps/step-06-innovation.md` if:
...
After user selects 'C' and content is saved to document, load `{project-root}/{aegis_folder}/bmm/workflows/2-plan-workflows/prd/steps/step-06-innovation.md`.
