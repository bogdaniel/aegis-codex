...
# Path Definitions
workflow_path: '{project-root}/{aegis_folder}/bmm/workflows/2-plan-workflows/prd'
...
- Load `{project-root}/{aegis_folder}/bmm/workflows/2-plan-workflows/prd/project-types.csv` completely
...
- Load `{project-root}/{aegis_folder}/bmm/workflows/2-plan-workflows/prd/steps/step-07-project-type.md`
...
If user selects 'A', proceed with content generation anyway. If 'C', skip this step and load `{project-root}/{aegis_folder}/bmm/workflows/2-plan-workflows/prd/steps/step-07-project-type.md`.
...
Skip this step and load `{project-root}/{aegis_folder}/bmm/workflows/2-plan-workflows/prd/steps/step-07-project-type.md` if:
...
After user selects 'C' and content is saved to document (or step is skipped), load `{project-root}/{aegis_folder}/bmm/workflows/2-plan-workflows/prd/steps/step-07-project-type.md`.
