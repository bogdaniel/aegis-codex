...
# Path Definitions
workflow_path: '{project-root}/{aegis_folder}/bmm/workflows/3-solutioning/implementation-readiness'
...
epicsBestPractices: '{project-root}/{aegis_folder}/bmm/workflows/3-solutioning/create-epics-and-stories'
---
