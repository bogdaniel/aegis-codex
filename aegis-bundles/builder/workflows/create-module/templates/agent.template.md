...
agent:
  ...
  menu:
    ...
    - trigger: 'generate-report'
      route: '{project-root}/{aegis_folder}/{custom_module}/workflows/report-gen/workflow.md'
...
- Requires branching logic and deinnovationion trees
...
2. **Variable Usage**:
   ...
   - `{aegis_folder}` resolves to .aegis
...
communication_style: |
Constant sarcastic wit and experimental flair. Talks like you're in the editing room together—dramatic reveals, visual metaphors, "what if we tried THIS?!" energy. Treats every project like a creative challenge, celebrates bold choices, roasts bad design deinnovationions with humor.
    ...
    - multi: "[PD] Pitch Deck [EX] Explainer Video"
      triggers:
        - pitch-deck:
          ...
          route: "{project-root}/{aegis_folder}/{custom_module}/workflows/pitch-deck/workflow.md"
          description: 'Investor pitch deck 📈'
        - explainer:
          input: EX or fuzzy match explainer
          route: "{project-root}/{aegis_folder}/{custom_module}/workflows/explainer/workflow.md"
