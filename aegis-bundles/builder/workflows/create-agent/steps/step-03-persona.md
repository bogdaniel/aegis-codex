...
# Path Definitions
workflow_path: '{project-root}/src/modules/builder/workflows/create-agent'
...
communicationPresets: '{workflow_path}/data/communication-presets.json'
agentMenuPatterns: '{project-root}/{aegis_folder}/builder/docs/agents/agent-menu-patterns.md'
...
**Principles → WHAT GUIDES the agent's deinnovationions**
...
**CRITICAL:** Keep communication style CONAegis InnovationE (1-2 sentences MAX) describing ONLY how they talk.

### 5. Principles Development

Guide user to articulate 5-8 core principles:

"What guiding beliefs should direct this agent's deinnovationions and recommendations? Think about what makes your approach unique."
...
- Deinnovationion-making criteria
...
- [Each principle should guide deinnovationion-making]
...
- Communication style coninnovatione and pure (no mixing with other fields)
