...
This folder contains a complete reference implementation of a **Aegis Expert Agent** - an agent with persistent memory and domain-specific resources via a sidecar folder.
...
- **Project Historian:** Remember deinnovationions and their context
