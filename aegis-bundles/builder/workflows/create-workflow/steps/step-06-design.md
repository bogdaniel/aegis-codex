...
- `{project-root}/{aegis_folder}/builder/docs/workflows/templates/step-template.md` - Step file structure
- `{project-root}/{aegis_folder}/builder/docs/workflows/templates/step-01-init-continuable-template.md` - Continuable init step template
- `{project-root}/{aegis_folder}/builder/docs/workflows/templates/step-1b-template.md` - Continuation step template
- `{project-root}/{aegis_folder}/builder/docs/workflows/templates/workflow-template.md` - Workflow configuration
- `{project-root}/{aegis_folder}/builder/reference/workflows/meal-prep-nutrition/workflow.md` - Complete example
...
```
Read: {project-root}/{aegis_folder}/builder/docs/workflows/templates/step-template.md
```

This shows the standard structure for step files. Also reference:

```
Read: {project-root}/{aegis_folder}/builder/docs/workflows/templates/step-1b-template.md
```
...
- What are the deinnovationion points within steps?
...
- Are there complex deinnovationions that might require multiple sessions?
