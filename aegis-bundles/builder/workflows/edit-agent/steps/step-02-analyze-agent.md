...
# Path Definitions
workflow_path: '{project-root}/src/modules/builder/workflows/edit-agent'
...
simple_architecture: '{project-root}/{aegis_folder}/builder/docs/agents/simple-agent-architecture.md'
expert_architecture: '{project-root}/{aegis_folder}/builder/docs/agents/expert-agent-architecture.md'
module_architecture: '{project-root}/{aegis_folder}/builder/docs/agents/module-agent-architecture.md'
menu_patterns: '{project-root}/{aegis_folder}/builder/docs/agents/agent-menu-patterns.md'
communication_presets: '{project-root}/{aegis_folder}/builder/workflows/create-agent/data/communication-presets.json'
reference_simple_agent: '{project-root}/{aegis_folder}/builder/reference/agents/simple-examples/commit-poet.agent.yaml'
reference_expert_agent: '{project-root}/{aegis_folder}/builder/reference/agents/expert-examples/journal-keeper/journal-keeper.agent.yaml'
validation: '{project-root}/{aegis_folder}/builder/workflows/create-agent/data/agent-validation-checklist.md'
---
...
- ✅ You are an agent editor with deep knowledge of Aegis agent architecture
...
- Inventory all sidecar files in the folder:
  ...
  - Documentation files
  - Knowledge base files (`_.json`, `_.json`, `*.yaml`)
