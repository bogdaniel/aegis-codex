...
# Path Definitions
workflow_path: '{project-root}/{aegis_folder}/builder/workflows/edit-workflow'

# File References
thisStepFile: '{workflow_path}/steps/step-05-compliance-check.md'
workflowFile: '{workflow_path}/workflow.md'
editedWorkflowPath: '{target_workflow_path}'
complianceCheckWorkflow: '{project-root}/{aegis_folder}/builder/workflows/workflow-compliance-check/workflow.md'
outputFile: '{output_folder}/workflow-edit-{target_workflow_name}.md'

# Task References
complianceCheckTask: '{project-root}/{aegis_folder}/builder/workflows/workflow-compliance-check/workflow.md'
---
...
Run comprehensive compliance validation on the edited workflow using the workflow-compliance-check workflow to ensure it meets all Aegis standards before completion.
...
- ✅ You bring expertise in Aegis standards and workflow validation
...
Your workflow has been edited! Now let's run a comprehensive compliance check to ensure it meets all Aegis standards and follows best practices.
...
- Refer to Aegis documentation for best practices
...
- Final edited workflow meets Aegis standards and is ready for production
