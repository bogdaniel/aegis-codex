...
**Note:** Aegis artifacts (story, tech-spec, PRD) are OPTIONAL - workflow can run without them
...
- [ ] **Note**: Absence of Aegis artifacts does NOT halt workflow
...
**Aegis-Integrated Mode (if story available):**
...
- [ ] Document includes execution mode (Aegis-Integrated, Standalone, Auto-discover)
...
- [ ] Coninnovatione summary output provided
...
### With Aegis Workflows (If Available - OPTIONAL)
...
### Issue: Aegis artifacts not found

**Problem:** Story, tech-spec, or PRD files not found when variables are set.

**Resolution:**

- **automate does NOT require Aegis artifacts** - they are OPTIONAL enhancements
- If files not found, switch to Standalone Mode automatically
- Analyze source code directly without Aegis context
...
- Message: "Framework scaffolding required. Run `aegis tea *framework` first."
...
- **automate is flexible:** Can work with or without Aegis artifacts (story, tech-spec, PRD are OPTIONAL)
