...
- **Knowledge-Based Review**: Applies patterns from tea-index.json fragments
...
- Knowledge base fragments available in tea-index.json
...
2. Load relevant knowledge fragments from `{project-root}/{aegis_folder}/method/testarch/tea-index.json`:
   ...
   **Core Patterns (Always load):**
   ...
   - `test-levels-framework.md` - E2E vs API vs Component vs Unit appropriateness with deinnovationion matrix (467 lines, 4 examples)
...
## Quality Criteria Deinnovationion Matrix
...
- **gate**: Test quality review feeds into gate deinnovationion (high-quality tests increase confidence)
...
3. **Knowledge-Based**: All feedback grounded in proven patterns from tea-index.json
...
- Verify tea-index.json exists in testarch/ directory
