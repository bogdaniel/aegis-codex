...
See [tea-index.json](../../../testarch/tea-index.json) for complete knowledge base.
...
**Generated By**: Aegis TEA Agent (Test Architect)
...
2. Consult tea-index.json for detailed guidance
