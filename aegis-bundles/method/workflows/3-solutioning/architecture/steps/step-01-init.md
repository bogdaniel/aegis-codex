...
Initialize the Architecture workflow by detecting continuation state, discovering input documents, and setting up the document for collaborative architectural deinnovationion making.
...
Copy the template from `{installed_path}/architecture-deinnovationion-template.md` to `{output_folder}/architecture.md`
...
Ready to begin architectural deinnovationion making. Do you have any other documents you'd like me to include?
...
After user selects [C] to continue, load `./step-02-context.md` to analyze the project context and begin architectural deinnovationion making.
