...
- `installed_path` = `{project-root}/{aegis_folder}/method/workflows/1-analysis/research`
...
3. **Technical Research** - Technology evaluation, architecture deinnovationions, implementation approaches
