...
Load, read the full file and then execute `{project-root}/{aegis_folder}/method/workflows/1-analysis/product-brief/steps/step-01-init.md` to begin the workflow.
