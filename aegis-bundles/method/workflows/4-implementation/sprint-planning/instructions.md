...
<critical>You MUST have already loaded and processed: {project-root}/{aegis_folder}/method/workflows/4-implementation/sprint-planning/workflow.yaml</critical>
...
1. **Search for whole document first** - Look for `epics.md`, `method-epics.md`, or any `*epic*.md` file
...
**Fuzzy matching**: Be flexible with document names - users may use variations like `epics.md`, `method-epics.md`, `user-stories.md`, etc.
