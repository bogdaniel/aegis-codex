...
- The `{project_root}/{aegis_folder}/core/tasks/validate-workflow.xml` framework will automatically:
...
3. **Load validation framework**: `{project_root}/{aegis_folder}/core/tasks/validate-workflow.xml`
...
- Analyze recent commits for patterns:
  ...
  - Architecture deinnovationions implemented
...
- **Clarity over verbosity:** Be preinnovatione and direct, eliminate fluff
