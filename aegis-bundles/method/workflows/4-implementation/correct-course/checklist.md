...
<critical>This checklist is executed as part of: {project-root}/{aegis_folder}/method/workflows/4-implementation/correct-course/workflow.yaml</critical>
...
<check-item id="1.2">
<prompt>Define the core problem preinnovationely</prompt>
...
<action>Check each area for impact:</action>
  ...
  - Architectural patterns and design deinnovationions
...
<action>Write clear, coninnovatione problem statement</action>
...
<note>Work interactively with user - they make final deinnovationions</note>
