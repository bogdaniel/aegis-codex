...
- Component strategy from step 11 informs pattern deinnovationions
...
Document specific design deinnovationions:
...
- Execute {project-root}/{aegis_folder}/core/tasks/advanced-elicitation.xml with the current UX patterns content
...
- Execute {project-root}/{aegis_folder}/core/workflows/party-mode/workflow.md with the current UX patterns
