...
<critical>This is a meta-workflow that orchestrates the Aegis Innovation brainstorming workflow with game-specific context and additional game design techniques</critical>
...
<workflow>
  ...
  <step n="2" goal="Load game brainstorming context and techniques">
    ...
    <action>These additional techniques supplement the standard Aegis Innovation brainstorming methods with game design-focused approaches like:
  ...
  <step n="3" goal="Invoke Aegis Innovation brainstorming with game context">
    <action>Execute the Aegis Innovation brainstorming workflow with game context and additional techniques</action>
    <invoke-workflow path="{core_brainstorming}" data="{game_context}" techniques="{game_brain_methods}">
      The Aegis Innovation brainstorming workflow will:
  ...
  <step n="4" goal="Update status and complete" tag="workflow-status">
    <check if="standalone_mode != true">
      ...
      <action>Update workflow_status["brainstorm-game"] = "{output_folder}/method-brainstorming-session-{{date}}.md"</action>
...
- Game brainstorming results saved to: {output_folder}/method-brainstorming-session-{{date}}.md
...
- Refer to the Aegis Method workflow guide if unsure what to do next
