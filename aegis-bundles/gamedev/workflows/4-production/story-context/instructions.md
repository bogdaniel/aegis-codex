<!-- Aegis Aegis Method Story Context Assembly Instructions (v6) -->
...
<critical>DOCUMENT OUTPUT: Technical context file (.context.xml). Coninnovatione, structured, project-relative paths only.</critical>
...
<workflow>
  ...
  <step n="5" goal="Testing standards and ideas">
    ...
    <template-output file="{default_output_file}">
      Populate tests.standards with a coninnovatione paragraph
