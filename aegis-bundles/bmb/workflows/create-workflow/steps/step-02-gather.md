...
```
Read: {project-root}/{aegis_folder}/bmb/reference/workflows/meal-prep-nutrition/workflow.md
```
...
- **Linear**: Like Meal Prep Plan (Init → Profile → Assessment → Strategy → Shopping → Prep)
  - See: `{project-root}/{aegis_folder}/bmb/reference/workflows/meal-prep-nutrition/`
