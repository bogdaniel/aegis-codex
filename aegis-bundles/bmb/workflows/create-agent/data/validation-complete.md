...
- Agent compilation guide: `{project-root}/{aegis_folder}/bmb/docs/agents/agent-compilation.md`
- Agent types guide: `{project-root}/{aegis_folder}/bmb/docs/agents/understanding-agent-types.md`
- Architecture docs: simple, expert, module agent architectures
- Menu patterns guide: `{project-root}/{aegis_folder}/bmb/docs/agents/agent-menu-patterns.md`
