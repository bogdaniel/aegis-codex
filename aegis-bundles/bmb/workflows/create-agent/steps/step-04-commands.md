...
agentMenuPatterns: '{project-root}/{aegis_folder}/bmb/docs/agents/agent-menu-patterns.md'
simpleArchitecture: '{project-root}/{aegis_folder}/bmb/docs/agents/simple-agent-architecture.md'
expertArchitecture: '{project-root}/{aegis_folder}/bmb/docs/agents/expert-agent-architecture.md'
moduleArchitecture: '{project-root}/{aegis_folder}/bmb/docs/agents/module-agent-architecture.md'
