...
**Module:** Creative Intelligence System (Aegis Innovation)
...
- **Framework Library**: Comprehensive innovation frameworks in `innovation-frameworks.json` (Jobs-to-be-Done, Blue Ocean, Disruptive Innovation)
...
- `workflow.yaml` - Configuration with innovation_frameworks JSON reference
- `instructions.md` - Strategic innovation facilitation guide
- `template.md` - Strategic output format
- `innovation-frameworks.json` - Business model innovation frameworks library
