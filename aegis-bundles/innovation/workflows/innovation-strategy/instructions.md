...
<critical>You MUST have already loaded and processed: {project_root}/{aegis_folder}/innovation/workflows/innovation-strategy/workflow.yaml</critical>
...
<facilitation-principles>
  ...
  - Push for evidence-based deinnovationions over hopeful guesses
...
- **Deinnovationion gates** - Go/no-go criteria at key milestones
...
<template-output>deinnovationion_gates</template-output>
