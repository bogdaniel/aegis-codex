...
- **Method Library**: Curated collection of design methods in `design-methods.json` organized by phase
...
- `workflow.yaml` - Configuration with design_methods JSON reference
- `instructions.md` - 7-step facilitation guide through design thinking phases
- `template.md` - Structured output format
- `design-methods.json` - Phase-specific design techniques library
