...
- **Technique Libraries** - JSON databases of proven methods
...
├── techniques.json     # Method library
...
- **Aegis Method** - Project brainstorming and ideation
