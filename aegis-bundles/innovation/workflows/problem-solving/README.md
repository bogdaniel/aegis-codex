...
- **Method Library**: Comprehensive solving methods in `solving-methods.json` (TRIZ, Theory of Constraints, Systems Thinking, Five Whys)
...
- `workflow.yaml` - Configuration with solving_methods JSON reference
- `instructions.md` - Systematic problem-solving facilitation guide
- `template.md` - Structured analysis output format
- `solving-methods.json` - Problem-solving methodology library
