...
<critical>You MUST have already loaded and processed: {project_root}/{aegis_folder}/innovation/workflows/storytelling/workflow.yaml</critical>
...
<action>Load story frameworks from {story_frameworks} JSON file</action>
...
<action>Reference key_elements from selected story_type in JSON</action>
...
- <ask>What core values drive every deinnovationion?</ask>
