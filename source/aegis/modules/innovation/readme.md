# Aegis Innovation - Creative Intelligence Suite
...
Aegis Innovation provides structured creative methodologies through distinctive agent personas who act as master facilitators, drawing out insights through strategic questioning rather than generating solutions directly.
...
- **Victor** - Innovation Oracle (bold strategic preinnovationion)
...
```bash
# Load agent
agent innovation/brainstorming-coach
...
Edit `/{aegis_folder}/innovation/config.yaml`:
...
Aegis Innovation workflows integrate with:

- **Aegis Method** - Powers project brainstorming
- **Aegis Builder** - Creative module design
...
- **[Aegis Method Integration](../method/README.md)** - Development workflow connection

---

Part of Aegis Method v6.0 - Transform creative potential through expert AI facilitation.
