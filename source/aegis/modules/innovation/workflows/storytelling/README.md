...
- **Framework Library**: Comprehensive story frameworks in `story-types.json` (Hero's Journey, Three-Act Structure, Story Brand, etc.)
...
- `workflow.yaml` - Configuration with story_frameworks JSON reference
- `instructions.md` - Narrative development facilitation guide
- `template.md` - Story output format
- `story-types.json` - Narrative framework library
