...
<critical>You MUST have already loaded and processed: {project_root}/{aegis_folder}/innovation/workflows/problem-solving/workflow.yaml</critical>
...
Establish clear problem definition before jumping to solutions. Explain in your own voice why preinnovatione problem framing matters before diving into solutions.
...
Reference the **Problem Statement Refinement** method from {solving_methods} to guide transformation of vague complaints into preinnovatione statements. Focus on:
...
- **Deinnovationion Matrix** - Good for comparing multiple options across criteria
