...
# Aegis Innovation Agents

The Creative Intelligence System provides five specialized agents, each embodying unique personas and expertise for facilitating creative and strategic processes. All agents are module agents with access to Aegis Innovation workflows.
...
All Aegis Innovation agents are **Module Agents** with:

- Integration with Aegis Innovation module configuration
...
Every Aegis Innovation agent includes:
...
All agents load configuration from `/{aegis_folder}/innovation/config.yaml`:
