# Aegis Game Development (Aegis Gamedev)
...
The Aegis Gamedev module brings together game-specific development workflows organized around industry-standard development phases:
...
- **Production** - Sprint-based implementation using Aegis Method workflows

## Installation

```bash
aegis install gamedev
```
...
- **game-architecture** - Define technical architecture (adapted from Aegis Method architecture workflow)

#### Phase 4: Production

Production workflows are provided by the Aegis Method module and accessible through the Game Dev Scrum Master agent:
...
│   │   └── game-architecture/
│   └── 4-production/
│       (Uses Aegis Method workflows via cross-module references)
├── templates/
├── data/
└── _module-installer/
    └── install-config.yaml
...
After installation, configure the module in `{aegis_folder}/gamedev/config.yaml`
...
Aegis Gamedev leverages the Aegis Method module for production/implementation workflows. The Game Dev Scrum Master agent provides access to:
...
This separation allows Aegis Gamedev to focus on game-specific design and architecture while using battle-tested agile implementation workflows.
...
1. Add new agents using `/aegis:builder:workflows:create-agent`
2. Add new workflows using `/aegis:builder:workflows:create-workflow`
3. Submit improvements via pull request

## Dependencies

- **Aegis Method Module** - Required for production/implementation workflows

## Author

Extracted and refined from Aegis Method module on 2025-11-05

## License

Part of the Aegis Method ecosystem
