...
<critical>DOCUMENT OUTPUT: Coninnovatione, technical, actionable story specifications. Use tables/lists for acceptance criteria and tasks.</critical>
         ...
         - If status is "done", "review", or "in-progress" (has some completion):
           ...
           * Parse ALL sections comprehensively:
             ...
             A) Dev Agent Record → Completion Notes List:
                ...
                - Architectural deviations or deinnovationions made
           ...
           * Store ALL findings as {{previous_story_learnings}} with structure:
             ...
             - architectural_deinnovationions: [list]
             - technical_debt: [list]
...
Will update existing story file rather than creating new one.
  ...
  <step n="7" goal="Create or update story document">
    ...
    <action>Compute a coninnovatione story_title from epic/story context; if missing, synthesize from PRD feature name and epic number.</action>
  ...
  <step n="8" goal="Validate, save, and mark story drafted" tag="sprint-status">
    <invoke-task>Validate against checklist at {installed_path}/checklist.md using {aegis_folder}/core/tasks/validate-workflow.xml</invoke-task>
