...
3. Tell me what code to review and what to review it for
  ...
  <step n="3" goal="Detect tech stack and establish best-practice reference set">
    ...
    <action>Synthesize a coninnovatione "Best-Practices and References" note capturing any updates or considerations that should influence the review (cite links and versions if available).</action>
  </step>
...
Review was saved to story file, but sprint-status.yaml may be out of sync.
  ...
  <step n="10" goal="Validation and completion">
    <invoke-task>Run validation checklist at {installed_path}/checklist.md using {project-root}/{aegis_folder}/core/tasks/validate-workflow.xml</invoke-task>
