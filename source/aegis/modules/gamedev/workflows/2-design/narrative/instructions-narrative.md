...
<check if="standalone_mode != true">
  ...
  <action>Update workflow_status["narrative"] = "{output_folder}/method-narrative-{{game_name}}-{{date}}.md"</action>
...
- Narrative design saved to {output_folder}/method-narrative-{{game_name}}-{{date}}.md
