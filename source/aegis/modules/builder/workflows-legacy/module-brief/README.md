...
The workflow uses standard Aegis Builder configuration:
...
- Document deinnovationion points and alternative paths
...
11. **Implementation Notes** - Priority order, design deinnovationions, open questions
...
4. **Reference During Development** - Use as north star for design deinnovationions and scope management
...
- Review the workflow creation guide at `/{aegis_folder}/builder/workflows/create-workflow/workflow-creation-guide.md`
- Study existing module examples in `/{aegis_folder}/` for patterns and inspiration
- Validate output using `checklist.md`
- Consult module structure guide at `create-module/module-structure.md`

---

_Part of the Aegis Method v6 - Aegis Builder (Builder) Module_
