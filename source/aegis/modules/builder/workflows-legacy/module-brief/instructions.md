...
<critical>You MUST have already loaded and processed: {project-root}/{aegis_folder}/builder/workflows/module-brief/workflow.yaml</critical>
...
- Other Aegis modules it might use
