...
<critical>You MUST have already loaded and processed: {project-root}/{aegis_folder}/builder/workflows/edit-module/workflow.yaml</critical>
...
<ask>What is the path to the module you want to edit? (provide path to module directory like {aegis_folder}/method/ or src/modules/method/)</ask>
...
- Study reference modules: Aegis Method, Aegis Builder, Aegis Innovation
- Understand Aegis module patterns and conventions
  </action>

<action>Analyze the module deeply:

- Identify module purpose and role in Aegis ecosystem
...
2. **Propose improvements with rationale**
   ...
   - Provide examples from reference modules: {method_module_dir}, {builder_module_dir}, {innovation_module_dir}
...
- Show how to reference workflows properly: {project-root}/{aegis_folder}/{{module}}/workflows/{{workflow}}/workflow.yaml
...
- "Looking at how Aegis Method organized this, we could use {{approach}}"
- "The Aegis convention is to {{pattern}} which helps with {{benefit}}"

Connect improvements to broader Aegis principles without being preachy.
</action>
...
If this is part of larger Aegis work:
