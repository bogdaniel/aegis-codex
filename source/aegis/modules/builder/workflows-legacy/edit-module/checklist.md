...
Use this checklist to validate module edits meet Aegis Core standards.

## Module Structure Validation

- [ ] Module has clear 3-letter code (method, builder, innovation, etc.)
- [ ] Module is in correct location (src/modules/ for source, {aegis_folder}/ for installed)
- [ ] agents/ directory exists
- [ ] workflows/ directory exists
- [ ] config.yaml exists in module root
- [ ] README.md exists in module root
- [ ] Directory structure follows Aegis conventions
...
- [ ] README explains module's role in Aegis ecosystem
...
- [ ] Paths are {aegis_folder}/-relative (not project-root)
