...
Interactive workflow for editing existing Aegis modules, including structure, agents, workflows, configuration, and documentation.

## Purpose

This workflow helps you improve and maintain Aegis modules by:
...
```yaml
# In agent menu item:
workflow: '{project-root}/{aegis_folder}/other-module/workflows/shared-workflow/workflow.yaml'
```

Common patterns:

- Aegis Method uses Aegis Innovation brainstorming workflows
...
**Installed modules** (in {aegis_folder}/):
...
```
User: I want to add a new workflow to Aegis Method for API design
Workflow: Analyzes Aegis Method → You choose option 8 (add new workflow)
...
Invoke via Aegis Builder agent:
...
- **Aegis Method Module** - Example of full-featured module
- **Aegis Builder Module** - Example of builder/tooling module
- **Aegis Innovation Module** - Example of workflow library module
