...
# Path Definitions
workflow_path: '{project-root}/{aegis_folder}/builder/workflows/workflow-compliance-check'
...
intentSpectrum: '{project-root}/{aegis_folder}/builder/docs/workflows/intent-vs-prescriptive-spectrum.md'
---
...
- 🚫 FORBIDDEN to make spectrum deinnovationions without user input
...
### 5. User Confirmation and Deinnovationion
...
**The Deinnovationion is Yours:** While I provide expert guidance, the final spectrum position should reflect your vision for the workflow."
...
### 6. Document Spectrum Deinnovationion

**A. Record User Deinnovationion:**
"**Spectrum Position Deinnovationion:**
...
✅ Deinnovationion documented for future reference
```
...
- IF C: Save spectrum deinnovationion to report, update frontmatter, then load, read entire file, then execute {nextStepFile}
...
- User makes informed deinnovationion about spectrum positioning
- Spectrum deinnovationion documented with implementation guidance
...
- Not documenting user deinnovationion for future reference
