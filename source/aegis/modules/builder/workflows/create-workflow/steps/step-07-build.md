...
# Path Definitions
workflow_path: '{project-root}/{aegis_folder}/builder/workflows/create-workflow'
...
# Template References
workflowTemplate: '{project-root}/{aegis_folder}/builder/docs/workflows/templates/workflow-template.md'
stepTemplate: '{project-root}/{aegis_folder}/builder/docs/workflows/templates/step-template.md'
stepInitContinuableTemplate: '{project-root}/{aegis_folder}/builder/docs/workflows/templates/step-01-init-continuable-template.md'
step1bTemplate: '{project-root}/{aegis_folder}/builder/docs/workflows/templates/step-1b-template.md'
...
- When building each step file, you must follow template `{project-root}/{aegis_folder}/builder/docs/workflows/templates/step-template.md`
- When building continuable step-01-init.md files, use template `{project-root}/{aegis_folder}/builder/docs/workflows/templates/step-01-init-continuable-template.md`
- When building continuation steps, use template `{project-root}/{aegis_folder}/builder/docs/workflows/templates/step-1b-template.md`
- When building the main workflow.md file, you must follow template `{project-root}/{aegis_folder}/builder/docs/workflows/templates/workflow-template.md`
- Example step files from {project-root}/{aegis_folder}/builder/reference/workflows/meal-prep-nutrition/workflow.md for patterns
...
For builder module, this will be: `{aegis_folder}/custom/src/workflows/{workflow_name}/`
...
- Configure all path variables ({project-root}, {_aegis_folder_}, {workflow_path})
