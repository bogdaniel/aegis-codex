...
commonToolsCsv: '{project-root}/{aegis_folder}/builder/docs/workflows/common-workflow-tools.json'
...
- ✅ You bring expertise in Aegis tools and integration patterns
...
- Installation requirements affect implementation deinnovationions
...
Based on your workflow requirements, let's configure all the tools your workflow will need. This includes core Aegis tools, memory systems, and any external integrations."

### 2. Load and Present Available Tools

Load `{commonToolsCsv}` and present tools by category:

"**Available Aegis Tools and Integrations:**
...
### 3. Configure Core Aegis Tools

"**Core Aegis Tools Configuration:**
...
1. **Party-Mode**
   ...
   - Where to integrate: [ask user for deinnovationion points, creative phases]
