...
- ✅ You bring expertise in Aegis installation patterns, user brings their module requirements
...
- 💬 Follow Aegis installer standards exactly
...
- Standard Aegis installer template to follow
...
1. User runs: `aegis install {module_name}`
2. Installer asks: [list of questions]
3. Creates: {aegis_folder}/{module_name}/
...
- Installer follows Aegis standards
