...
agent_examples_path: '{project-root}/src/modules/builder/reference/agents/module-examples'
...
- ✅ You bring expertise in Aegis agent patterns, user brings their domain requirements
...
I'll create each agent following the proper Aegis template and set up placeholder workflow folders for them."
  ...
  menu:
    ...
    - multi: '[CH] Chat with agent or [SPM] Start Party Mode'
      triggers:
        - party-mode:
          input: SPM
          route: '{project-root}/{aegis_folder}/core/workflows/edit-agent/workflow.md'
          type: exec
        - expert-chat:
          input: CH
    ...
    - trigger: 'complex-process'
      route: '{project-root}/{aegis_folder}/{custom_module}/workflows/[workflow]/workflow.md'
