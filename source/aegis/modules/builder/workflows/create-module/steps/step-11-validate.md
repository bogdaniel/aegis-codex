...
- ✅ You bring expertise in Aegis validation patterns, user brings their module knowledge
...
"Let's validate your {module_display_name} module to ensure it meets all Aegis standards and is ready for use.
...
5. **Share Your Module:**
   ...
   - Consider submitting to Aegis registry
...
Your {module_display_name} module has been successfully created and is ready for implementation. You now have a complete, installable Aegis module structure with everything needed to move forward.
...
- IF A: Execute {project-root}/{aegis_folder}/core/tasks/advanced-elicitation.xml for reflection on process
- IF P: Execute {project-root}/{aegis_folder}/core/workflows/party-mode/workflow.md to celebrate completion
