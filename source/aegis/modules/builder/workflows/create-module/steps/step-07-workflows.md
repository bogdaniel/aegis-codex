...
- ✅ You bring expertise in Aegis workflow patterns, user brings their workflow requirements
...
[Clear, coninnovatione description of what this workflow accomplishes]
...
1. Use the `/aegis:builder:workflows:create-workflow` command
