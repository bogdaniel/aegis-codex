...
agentTypesGuide: '{project-root}/{aegis_folder}/builder/docs/agents/understanding-agent-types.md'
...
- 💾 Document purpose and type deinnovationions clearly
...
**Agent Type Deinnovationion Framework:**
