...
configOutputFile: '{project-root}/{aegis_folder}/_cfg/agents/{target_module}-{agent_filename}.customize.yaml'
...
ONLY WHEN [C continue option] is selected and [customization deinnovationion made and file created if requested], will you then load and read fully `{nextStepFile}` to execute and begin build tools handling.
...
- Customization deinnovationion made clearly (create or skip)
