...
simpleArchitecture: '{project-root}/{aegis_folder}/builder/docs/agents/simple-agent-architecture.md'
expertArchitecture: '{project-root}/{aegis_folder}/builder/docs/agents/expert-agent-architecture.md'
moduleArchitecture: '{project-root}/{aegis_folder}/builder/docs/agents/module-agent-architecture.md'
...
"Should this agent have special prompts for complex analyses or critical deinnovationion points?"
...
- Menu patterns compliant with Aegis standards
