...
**Legacy Workflow:** `src/modules/builder/workflows-legacy/create-agent/workflow.yaml` + `instructions.md`
**New Workflow:** `src/modules/builder/workflows/create-agent/workflow.md` + 11 step files
...
- Agent compilation guide: `{project-root}/{aegis_folder}/builder/docs/agents/agent-compilation.md`
- Agent types guide: `{project-root}/{aegis_folder}/builder/docs/agents/understanding-agent-types.md`
- Architecture docs: simple, expert, module agent architectures
- Menu patterns guide: `{project-root}/{aegis_folder}/builder/docs/agents/agent-menu-patterns.md`
- Status: ✅ ALL REFERENCES PRESERVED

**Communication Presets**

- Original: `communication-presets.json` with 13 categories
- New: `data/communication-presets.json` (copied)
...
- Legacy: Interactive input at each deinnovationion point
