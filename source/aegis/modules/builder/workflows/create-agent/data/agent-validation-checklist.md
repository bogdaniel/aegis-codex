# Aegis Agent Validation Checklist

Use this checklist to validate agents meet Aegis quality standards, whether creating new agents or editing existing ones.

## YAML Structure Validation (Source Files)

- [ ] YAML parses without errors
- [ ] `agent.metadata` includes: `id`, `name`, `title`, `icon`
- [ ] `agent.metadata.module` present if Module agent (e.g., `method`, `gamedev`, `innovation`)
...
- [ ] Compare against reference agents (commit-poet, journal-keeper, Aegis Method agents) - similar quality?
...
- [ ] Designed FOR specific module (Aegis Method, Aegis Gamedev, Aegis Innovation, etc.)
...
✓ Comparable quality to reference agents (commit-poet, journal-keeper, Aegis Method agents)
