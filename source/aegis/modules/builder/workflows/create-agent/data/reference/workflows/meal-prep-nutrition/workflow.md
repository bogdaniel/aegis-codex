...
Load, read the full file and then execute `{project-root}/{aegis_folder}/builder/reference/workflows/meal-prep-nutrition/steps/step-01-init.md` to begin the workflow.
