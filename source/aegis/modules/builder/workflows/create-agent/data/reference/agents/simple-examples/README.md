...
This folder contains a complete reference implementation of a **Aegis Simple Agent** - a self-contained agent with all logic embedded within a single YAML file.
...
- Commands stay coninnovatione in the menu
...
agent:
  metadata:
    id: .aegis/agents/{agent-name}/{agent-name}.md  # Build path
    name: "Display Name"
...
3. Principles define WHAT guides their deinnovationions
...
_This reference demonstrates how Aegis Simple Agents can be surprisingly powerful while maintaining architectural simplicity._
