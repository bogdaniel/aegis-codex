...
- ✅ User makes deinnovationions and approves changes
...
- `{project-root}/{aegis_folder}/builder/docs/workflows/templates/step-template.md`
- `{project-root}/{aegis_folder}/builder/docs/workflows/templates/workflow-template.md`
- `{project-root}/{aegis_folder}/builder/docs/workflows/architecture.md`
