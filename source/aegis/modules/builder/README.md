# Aegis Builder - Aegis Builder Module

Specialized tools and workflows for creating, customizing, and extending Aegis components including agents, workflows, and complete modules.
...
**Aegis Builder** - Master builder agent orchestrating all creation workflows with deep knowledge of Aegis architecture and conventions.

- Location: `.aegis/builder/agents/aegis-builder.md`

### 📋 Workflows

**Active Workflows** (Step-File Architecture)

- Location: `src/modules/builder/workflows/`
- 5 core workflows with 41 step files total
- Template-based execution with JIT loading

**Legacy Workflows** (Being Migrated)

- Location: `src/modules/builder/workflows-legacy/`
- Module-specific workflows pending conversion to step-file architecture

### 📚 Documentation

- Location: `src/modules/builder/docs/`
- Comprehensive guides for agents and workflows
- Architecture patterns and best practices

### 🔍 Reference Materials

- Location: `src/modules/builder/reference/`
...
- **[Module Agent Examples](./reference/agents/module-examples/)** - Integration patterns (Aegis Method, Aegis Innovation)
...
**[create-agent](./workflows/create-agent/)** - Build Aegis agents
...
Aegis Builder creates three agent architectures:
...
- **Examples**: Aegis Method project manager, Aegis Innovation innovation strategist

## Quick Start

### Using Aegis Builder Agent

1. **Load Aegis Builder agent** in your IDE:
   ```
   /aegis:builder:agents:aegis-builder
   ```
...
Aegis Builder components integrate with:

- **Aegis Core** - Framework foundation and agent compilation
- **Aegis Method** - Development workflows and project management
- **Aegis Innovation** - Creative innovation and strategic workflows
...
Aegis Builder provides a complete toolkit for extending Aegis Method with disciplined, systematic approaches to agent and workflow development while maintaining framework consistency and power.
