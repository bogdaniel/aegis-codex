# Aegis Workflows Documentation

Welcome to the Aegis Workflows documentation - a modern system for creating structured, collaborative workflows optimized for AI execution.

## 📚 Core Documentation

### [Terms](./terms.md)

Essential terminology and concepts for understanding Aegis workflows.

### [Architecture & Execution Model](./architecture.md)

The micro-file architecture, JIT step loading, state management, and collaboration patterns that make Aegis workflows optimal for AI execution.
...
Aegis workflows are pure markdown, self-contained systems that guide collaborative processes through structured step files where the AI acts as a facilitator working with humans.

---

_This documentation covers the next generation of Aegis workflows - designed from the ground up for optimal AI-human collaboration._
