# CSV Data File Standards for Aegis Workflows

## Purpose and Usage

CSV data files in Aegis workflows serve specific purposes for different workflow types:
...
**For Workflows:** Include reference data, configuration parameters, or structured inputs that guide workflow execution and deinnovationion-making.
...
**Result:** Transform from context-blowing document loads to surgical preinnovationion lookups, creating agents with near-infinite knowledge bases while maintaining optimal context usage.
...
When creating CSV data files for Aegis workflows:
