...
The **Intent vs Prescriptive Spectrum** is a fundamental design principle for Aegis workflows and agents. It determines how much creative freedom an LLM has versus how strictly it must follow predefined instructions.
...
1. **Early Spectrum Deinnovationion**: Determine spectrum position during initial design
...
- "Follow this script preinnovationely: ..." (vs "Cover these points...")
...
persona:
  ...
  governing_rules:
    ...
    - 'Follow sequence preinnovationely as defined'
...
- ✅ Make conscious spectrum deinnovationions during design
...
The Intent vs Prescriptive Spectrum is not about good vs. bad - it's about **appropriate design choices**. The best workflows make conscious deinnovationions about where they fall on this spectrum based on their specific requirements, user needs, and risk considerations.
