# Aegis Workflow Step 1B Continuation Template
...
workflow*path: '{project-root}/{\_aegis_folder*}/[module-path]/workflows/[workflow-name]'
...
2. **Read the complete step file** to understand:
   ...
   - Any specific context or deinnovationions made
...
- User deinnovationions and preferences
...
"Are you still aligned with the goals and deinnovationions we made earlier?"
...
- `[module-path]` - e.g., "builder/reference" or "custom"
...
4. **Context preservation** - the key is maintaining all previous work and deinnovationions
