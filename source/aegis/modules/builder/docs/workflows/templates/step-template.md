# Aegis Workflow Step Template

This template provides the standard structure for all Aegis workflow step files. Copy and modify this template for each new step you create.
...
workflow*path: '{project-root}/{\_aegis_folder*}/builder/reference/workflows/[workflow-name]' # the folder the workflow.md file is in
...
advancedElicitationTask: '{project-root}/{_aegis_folder_}/core/tasks/advanced-elicitation.xml'
partyModeWorkflow: '{project-root}/{_aegis_folder_}/core/workflows/party-mode/workflow.md'
...
someData: '{workflow_path}/data/foo.json'
...
4. **Use clear, coninnovatione language** - Avoid jargon unless necessary
