...
- ✓ Use core variables ({aegis_folder}, {output_folder}, etc.)
...
agent:
  ...
  menu:
    - trigger: implement-story
      workflow: '{aegis_folder}/method/workflows/dev-story/workflow.yaml'
      description: Implement user story

    - trigger: refactor
      workflow: '{aegis_folder}/method/workflows/refactor/workflow.yaml'
...
- ✓ Coordinates with other Aegis Method agents
...
- A Simple agent COULD live in `.aegis/method/agents/`
...
1. **Designed FOR** a particular module ecosystem (Aegis Method, Aegis Innovation, Aegis Builder, etc.)
...
**Simple Agent added to Aegis Method:**

- Lives in `.aegis/method/agents/formatter.agent.yaml`
- Bundled with Aegis Method for convenience
- But still stateless, self-contained
- NOT a "Module Agent" - just a Simple agent in a module

**Module Agent in Aegis Method:**

- Lives in `.aegis/method/agents/tech-writer.agent.yaml`
- Orchestrates Aegis Method documentation workflows
- Coordinates with other Aegis Method agents (PM, Dev, Analyst)
- Included in default Aegis Method bundle
- IS a "Module Agent" - designed for Aegis Method ecosystem
...
- Designed FOR a specific module ecosystem (Aegis Method, Aegis Innovation, etc.)
