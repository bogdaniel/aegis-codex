...
- Example: `.aegis/custom/agents/journal-keeper/`
...
See: `src/modules/builder/reference/agents/expert-examples/journal-keeper/`
...
cp -r /path/to/journal-keeper/ .aegis/custom/agents/
