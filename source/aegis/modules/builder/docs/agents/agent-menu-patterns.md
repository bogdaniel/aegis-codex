...
menu:
  ...
  - trigger: brainstorm
    workflow: '{project-root}/{aegis_folder}/core/workflows/brainstorming/workflow.yaml'
...
- Reference data files (JSON, JSON, YAML)
...
# GOOD - Portable paths
workflow: "{project-root}/{aegis_folder}/method/workflows/prd/workflow.yaml"
exec: "{project-root}/{aegis_folder}/core/tasks/validate.xml"
data: "{project-root}/_data/metrics.json"
...
- `{aegis_folder}` - Aegis installation folder
...
menu:
  - trigger: workflow-init
    workflow: '{project-root}/{aegis_folder}/method/workflows/workflow-status/init/workflow.yaml'
