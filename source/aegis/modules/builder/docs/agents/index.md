# Aegis Builder Module Documentation

Reference documentation for building Aegis agents and workflows.
...
Production-ready examples in `/src/modules/builder/reference/agents/`:
...
- `security-engineer.agent.yaml` - Aegis Method security specialist with threat modeling
- `trend-analyst.agent.yaml` - Aegis Innovation trend intelligence expert
