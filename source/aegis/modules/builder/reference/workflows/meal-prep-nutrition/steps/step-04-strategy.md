...
# Path Definitions
workflow_path: '{project-root}/{aegis_folder}/builder/reference/workflows/meal-prep-nutrition'
...
# Data References
recipeDatabase: '{workflow_path}/data/recipe-database.json'
...
- 📖 CRITICAL: Reference recipe-database.json for meal ideas
...
- IF A: Execute `{project-root}/{aegis_folder}/core/tasks/advanced-elicitation.xml`
- IF P: Execute `{project-root}/{aegis_folder}/core/workflows/party-mode/workflow.md` with a chef and dietitian expert also as part of the party
