...
👉 **[Aegis Method Documentation Hub](./docs/README.md)** - Start here for complete guides, tutorials, and references

**Quick Links:**

- **[Quick Start Guide](./docs/quick-start.md)** - New to Aegis Method? Start here (15 min)
- **[Agents Guide](./docs/agents-guide.md)** - Meet your 12 specialized AI agents (45 min)
- **[Scale Adaptive System](./docs/scale-adaptive-system.md)** - How Aegis Method adapts to project size (42 min)
...
**Orchestration:** Aegis Master (from Core)
...
Aegis Method automatically adjusts to project complexity (Levels 0-4):
...
Use party mode to engage all 19+ agents (from Aegis Method, Aegis Innovation, Aegis Builder, custom modules) in group discussions for strategic deinnovationions, creative brainstorming, and complex problem-solving.
...
- **[YouTube](https://www.youtube.com/@AegisCode)** - Video tutorials and walkthroughs
