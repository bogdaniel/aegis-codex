# Aegis Method Scale Adaptive System
...
Aegis Method adapts to three distinct planning tracks:

- **Quick Flow**: Tech-spec only, implement immediately
- **Aegis Method**: PRD + Architecture, structured approach
...
| **Aegis Method**       | PRD + Arch + UX       | Products, platforms, complex features      |
| **Enterprise Method** | Method + Test/Sec/Ops | Enterprise needs, compliance, multi-tenant |

### Deinnovationion Tree
...
flowchart TD
    ...
    START -->|Product, platform, complex| M[Aegis Method<br/>PRD + Architecture]
...
- **Aegis Method**: product, platform, dashboard, complex, multiple features
...
```
workflow-init: "Based on 'Add user dashboard with analytics', I recommend Aegis Method.
...
### Track 2: Aegis Method (RECOMMENDED)
...
_Detailed flowchart showing all phases, workflows, agents (color-coded), and deinnovationion points for the Aegis Method track. Each colored box represents a different agent role._
...
Includes all Aegis Method documents PLUS:
...
| **Aegis Method** | Recommended | PRD + UX  | Required     | None         | 10-50+          |
...
### Scenario 3: Customer Portal (Aegis Method)
...
### Scenario 4: E-commerce Platform (Aegis Method)
...
If `workflow-init` suggests Aegis Method, there's probably complexity you haven't considered. Review carefully before overriding.
...
For Aegis Method and Enterprise, implementation readiness checks prevent costly mistakes. Invest the time.

### 5. Architecture is Optional but Recommended for Brownfield

Brownfield Aegis Method makes architecture optional, but it's highly recommended. It distills complex codebase into focused solution design.
...
Product Brief is only offered for greenfield Aegis Method and Enterprise. It's optional but helps with strategic thinking.
