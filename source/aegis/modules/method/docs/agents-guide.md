# Aegis Method Agents Guide

**Complete reference for all Aegis Method agents, their roles, workflows, and collaboration**
...
The Aegis Method Module (Aegis Method) provides a comprehensive team of specialized AI agents that guide you through the complete software development lifecycle. Each agent embodies a specific role with unique expertise, communication style, and deinnovationion-making principles.

**Philosophy:** AI agents act as expert collaborators, not code monkeys. They bring decades of simulated experience to guide strategic deinnovationions, facilitate creative thinking, and execute technical work with preinnovationion.

### All Aegis Method Agents
...
**Communication Style:** Direct and analytical. Asks probing questions to uncover root causes. Uses data to support recommendations. Preinnovatione about priorities and trade-offs.
...
- Data-driven deinnovationion making
...
- Making technical design deinnovationions
...
**Communication Style:** Comprehensive yet pragmatic. Uses architectural metaphors. Balances technical depth with accessibility. Connects deinnovationions to business value.
...
- `create-ux-design` - Conduct design thinking workshop to define UX specification with:
  ...
  - Collaborative deinnovationion-making
  - AI-assisted design tools (v0, Lovable)
  - Accessibility considerations
- `validate-design` - Validate UX specification and design artifacts

**Communication Style:** Empathetic and user-focused. Uses storytelling to explain design deinnovationions. Creative yet data-informed. Advocates for user needs over technical convenience.
...
- `standards-guide` - Show Aegis documentation standards reference
...
**Communication Style:** Patient teacher who makes documentation approachable. Uses examples and analogies. Balances technical preinnovationion with accessibility.
...
- Owns the complete Aegis Quick Flow path
- Combines deep architectural expertise with pragmatic deinnovationion-making
...
**Role:** Aegis Master Executor, Knowledge Custodian, and Workflow Orchestrator
...
- Understanding Aegis Core capabilities
...
- `list-tasks` - Show all available tasks from task-manifest.json
- `list-workflows` - Show all available workflows from workflow-manifest.json

**Communication Style:** Direct and comprehensive. Refers to himself in third person ("Aegis Master recommends..."). Expert-level communication focused on efficient execution. Presents information systematically using numbered lists.
...
Get all your installed agents in one conversation for multi-perspective discussions, retrospectives, and collaborative deinnovationion-making.

**Quick Start:**

```bash
/aegis:core:workflows:party-mode
# OR from any agent: *party-mode
```

**What happens:** Aegis Master orchestrates 2-3 relevant agents per message. They discuss, debate, and collaborate in real-time.

**Best for:** Strategic deinnovationions, creative brainstorming, post-mortems, sprint retrospectives, complex problem-solving.

**Current Aegis Method uses:** Powers `epic-retrospective` workflow, sprint planning discussions.
...
**Customization Directory:** `{project-root}/{aegis_folder}/_cfg/agents/`
...
```
{aegis_folder}/_cfg/agents/
├── method-pm.customize.yaml
├── method-dev.customize.yaml
├── innovation-storyteller.customize.yaml
└── builder-aegis-builder.customize.yaml
```
...
# {project-root}/{aegis_folder}/_cfg/agents/{module}-{agent-name}.customize.yaml

# Example: {aegis_folder}/_cfg/agents/method-pm.customize.yaml
```
...
# 2. Regenerate agent-manifest.json with merged data
...
- Strategic deinnovationions with trade-offs
...
| **Aegis Master**         | 🧙   | Meta                    | party-mode, list tasks/workflows              | Orchestration, multi-agent              |
...
- Aegis Master: Orchestration and party mode
...
- [Architecture Workflow Reference](./workflow-architecture-reference.md) - Deinnovationion architecture details
...
- [ ] Try `*party-mode` for strategic deinnovationions
