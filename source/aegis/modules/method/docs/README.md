# Aegis Method Documentation

Complete guides for the Aegis Method Module (Aegis Method) - AI-powered agile development workflows that adapt to your project's complexity.

---

## 🚀 Getting Started

**New to Aegis Method?** Start here:
...
**[Complete Workflow Diagram](./images/workflow-method-greenfield.svg)** - Visual flowchart showing all phases, agents (color-coded), and deinnovationion points for the Aegis Method standard greenfield track.

---

## 📖 Core Concepts

Understanding how Aegis Method adapts to your needs:

- **[Scale Adaptive System](./scale-adaptive-system.md)** - How Aegis Method adapts to project size and complexity (42 min read)
  - Three planning tracks (Quick Flow, Aegis Method, Enterprise Method)
  - Automatic track recommendation
  - Documentation requirements per track
  - Planning workflow routing

- **[Aegis Quick Flow](./aegis-quick-flow.md)** - Fast-track development workflow (32 min read)
...
- **[Quick Flow Solo Dev Agent](./quick-flow-solo-dev.md)** - Elite solo developer for rapid development (18 min read)
  ...
  - Lives and breathes the Aegis Quick Flow workflow
...
Complete guide to Aegis Method's AI agent team:

- **[Agents Guide](./agents-guide.md)** - Comprehensive agent reference (45 min read)
  - 12 specialized Aegis Method agents + Aegis Master
...
- **[Party Mode Guide](./party-mode.md)** - Multi-agent collaboration (20 min read)
  ...
  - Multi-module integration (Aegis Method + Aegis Innovation + Aegis Builder + custom)
...
→ Go to [Aegis Quick Flow](./aegis-quick-flow.md) for rapid development
...
Comprehensive documentation for all Aegis Method workflows organized by phase:
...
- **[Phase 2: Planning Workflows](./workflows-planning.md)** - Scale-adaptive planning (967 lines)
  ...
  - Track-based planning approach (Quick Flow, Aegis Method, Enterprise Method)
...
- **[Phase 3: Solutioning Workflows](./workflows-solutioning.md)** - Architecture and validation (638 lines)
  ...
  - Required for Aegis Method and Enterprise Method tracks
...
- **[Testing & QA Workflows](./test-architecture.md)** - Comprehensive quality assurance (1,420 lines)
  ...
  - Aegis-integrated vs standalone modes
...
- **[Architecture Workflow Reference](./workflow-architecture-reference.md)** - Deinnovationion architecture guide (320 lines)
...
Understanding Aegis Method components:

- **[Aegis Method Module README](../README.md)** - Overview of module structure
...
- **[GitHub Issues](https://github.com/aegis-code-org/Aegis-METHOD/issues)** - Report bugs or request features
- **[YouTube Channel](https://www.youtube.com/@AegisCode)** - Video tutorials and walkthroughs
...
```mermaid
flowchart TD
    START[New to Aegis Method?]
    START --> QS[Quick Start Guide]

    QS --> DECIDE{What are you building?}

    DECIDE -->|Bug fix or<br/>small feature| QF[Aegis Quick Flow]
