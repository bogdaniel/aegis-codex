...
Quick Spec Flow is a **streamlined alternative** to the full Aegis Method for Quick Flow track projects. Instead of going through Product Brief → PRD → Architecture, you go **straight to a context-aware technical specification** and start coding.
...
❌ **Use Aegis Method or Enterprise tracks when:**
...
## Comparison: Quick Spec vs Full Aegis Method

| Aspect                | Quick Flow Track             | Aegis Method/Enterprise Tracks      |
| --------------------- | ---------------------------- | ---------------------------------- |
...
## When to Graduate from Quick Flow to Aegis Method

Start with Quick Flow, but switch to Aegis Method when:

- ❌ Project grows beyond initial scope
- ❌ Multiple teams need coordination
- ❌ Stakeholders need formal documentation
- ❌ Product vision is unclear
- ❌ Architectural deinnovationions need deep analysis
- ❌ Compliance/regulatory requirements exist

💡 **Tip:** You can always run `workflow-init` later to transition from Quick Flow to Aegis Method!
...
- Auto-validation
- Definitive deinnovationions (no "or" statements)
...
- Aegis Method installed (`npx aegis install`)
...
**A:** No problem! You can always transition to Aegis Method by running workflow-init and create-prd. Your tech-spec becomes input for the PRD.
...
- **Learn more:** See the [Aegis Method Workflow Guides](./README.md#-workflow-guides) for comprehensive workflow documentation
