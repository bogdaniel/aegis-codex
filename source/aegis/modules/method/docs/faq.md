# Aegis Method Frequently Asked Questions

Quick answers to common questions about the Aegis Method Module.
...
1. Install Aegis Method: `npx aegis@alpha install`
...
**A:** Check your `method-workflow-status.md` file (created by workflow-init). It shows your current phase and progress. If you don't have this file, you can also tell by what you're working on:
...
- Conflicting design deinnovationions
...
Aegis Method respects your choice - it won't force modernization, but it will offer it.
...
All Aegis Method docs use valid Mermaid syntax that should render in GitHub, VS Code, and most IDEs.

### Q: Can I use Aegis Method with GitHub Copilot / Cursor / other AI tools?

**A:** Yes! Aegis Method is complementary. Aegis Method handles:
...
### Q: What IDEs/tools support Aegis Method?

**A:** Aegis Method requires tools with **agent mode** and access to **high-quality LLM models** that can load and follow complex workflows, then properly implement code changes.
...
- **Claude Code** ⭐ **Best choice**
  ...
  - Native agent mode designed for Aegis Method workflows
...
- **Windsurf**
  - Multi-model support
  - Agent capabilities
  - Suitable for Aegis Method workflows
...
**Why model quality matters:** Aegis Method workflows require LLMs that can follow multi-step processes, maintain context across phases, and implement code that adheres to specifications. Tools with weaker models will struggle with workflow adherence and code quality.

See [IDE Setup Guides](https://github.com/aegis-code-org/Aegis-METHOD/tree/main/docs/ide-info) for configuration specifics.

### Q: Can I customize agents?

**A:** Yes! Agents are installed as markdown files with XML-style content (optimized for LLMs, readable by any model). Create customization files in `{aegis_folder}/_cfg/agents/[agent-name].customize.yaml` to override default behaviors while keeping core functionality intact. See agent documentation for customization options.
...
- Historical record of deinnovationions
...
### Q: Can I use Aegis Method for non-software projects?

**A:** Aegis Method is optimized for software development, but the methodology principles (scale-adaptive planning, just-in-time design, context injection) can apply to other complex project types. You'd need to adapt workflows and agents for your domain.
...
Trust your expertise - Aegis Method supports your deinnovationions.

### Q: Can multiple developers work on the same Aegis Method project?
...
**With Aegis Method + AI agents:** A single dev can complete an entire epic in 1-3 days. What used to take months now takes days.
...
- Use **git submodules** for Aegis Method installation (not .gitignore)
...
- Use git submodules for Aegis Method in enterprise settings
...
**A:** Party mode is a unique multi-agent collaboration feature where ALL your installed agents (19+ from Aegis Method, Aegis Innovation, Aegis Builder, custom modules) discuss your challenges together in real-time.

**How it works:**

1. Run `/aegis:core:workflows:party-mode` (or `*party-mode` from any agent)
2. Introduce your topic
3. Aegis Master selects 2-3 most relevant agents per message
4. Agents cross-talk, debate, and build on each other's ideas

**Best for:**

- Strategic deinnovationions with trade-offs (architecture choices, tech stack, scope)
...
- **Product Strategy:** PM + Innovation Strategist (Aegis Innovation) + Analyst
- **Technical Design:** Architect + Creative Problem Solver (Aegis Innovation) + Game Architect
- **User Experience:** UX Designer + Design Thinking Coach (Aegis Innovation) + Storyteller (Aegis Innovation)
...
3. Open a [GitHub Issue](https://github.com/aegis-code-org/Aegis-METHOD/issues)
4. Watch [YouTube Tutorials](https://www.youtube.com/@AegisCode)

### Q: How do I report a bug or request a feature?

**A:** Open a GitHub issue at: <https://github.com/aegis-code-org/Aegis-METHOD/issues>

Please include:

- Aegis Method version (check your installed version)
...
- [Quick Start Guide](./quick-start.md) - Get started with Aegis Method
...
**Have a question not answered here?** Please [open an issue](https://github.com/aegis-code-org/Aegis-METHOD/issues) or ask in [Discord](https://discord.gg/gk8jAdXWmj) so we can add it!
