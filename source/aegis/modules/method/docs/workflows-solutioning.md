# Aegis Method Solutioning Workflows (Phase 3)

## Overview

Phase 3 (Solutioning) workflows translate **what** to build (from Planning) into **how** to build it (technical design). This phase prevents agent conflicts in multi-epic projects by documenting architectural deinnovationions before implementation begins.

**Key principle:** Make technical deinnovationions explicit and documented so all agents implement consistently. Prevent one agent choosing REST while another chooses GraphQL.

**Required for:** Aegis Method (complex projects), Enterprise Method

**Optional for:** Aegis Method (simple projects), Quick Flow (skip entirely)
...
| ---------------------------- | ----------- | ------------------------ | -------------------------------------------- |
| **create-ux-design**         | UX Designer | Aegis Method, Enterprise  | Optional UX design (after PRD, before arch)  |
| **architecture**             | Architect   | Aegis Method, Enterprise  | Technical architecture and design deinnovationions  |
| **create-epics-and-stories** | PM          | Aegis Method, Enterprise  | Break FRs/NFRs into epics after architecture |
| **implementation-readiness** | Architect   | Aegis Complex, Enterprise | Validate planning/solutioning completeness   |
...
- **Aegis Method:** Multi-epic projects need architecture to prevent conflicts
- **Enterprise:** Same as Aegis Method, plus optional extended workflows (test architecture, security architecture, devops strategy) added AFTER architecture but BEFORE gate check
...
All agents follow architecture deinnovationions
...
**Purpose:** Make technical deinnovationions explicit to prevent agent conflicts. Produces deinnovationion-focused architecture document optimized for AI consistency.

**Agent:** Architect

**When to Use:**

- Multi-epic projects (Aegis Complex, Enterprise)
...
- Aegis Method Simple with straightforward tech stack
...
3. **Documents** deinnovationions that prevent agent conflicts
4. **Focuses** on deinnovationion points, not exhaustive documentation
...
9. **Architecture Deinnovationion Records (ADRs)** - Key deinnovationions with context, options, trade-offs, rationale
...
**Deinnovationion:** Use GraphQL for all client-server communication
...
**Purpose:** Transform PRD's functional and non-functional requirements into bite-sized stories organized into deliverable functional epics. This workflow runs AFTER architecture so epics/stories are informed by technical deinnovationions.
...
- architecture.md with ADRs and technical deinnovationions
...
1. **Informed Story Sizing:** Architecture deinnovationions (database choice, API style, etc.) affect story complexity
...
5. Technical notes referencing architecture deinnovationions
...
- **Always** before Phase 4 for Aegis Complex and Enterprise projects
...
- Aegis Simple (no gate check required)
...
- ❌ Epics conflict with architecture deinnovationions
...
- Epics align with architecture deinnovationions
- No contradictions between epics
- NFRs have technical approach
- Integration points clear

**Gate Deinnovationion Logic:**
...
- Architecture missing key deinnovationions
...
6. Gate Deinnovationion with rationale
7. Next Steps
...
**Note:** Enterprise uses the same planning and architecture as Aegis Method. The only difference is optional extended workflows added AFTER architecture but BEFORE create-epics-and-stories.
...
2. **ADRs** (in architecture) → Referenced by agents for technical deinnovationions
...
- **dev-story** - References architecture deinnovationions and ADRs
...
### 1. Make Deinnovationions Explicit

Don't leave technology choices implicit. Document deinnovationions with rationale in ADRs so agents understand context.
...
### 3. Use ADRs for Key Deinnovationions

Every significant technology choice should have an ADR explaining "why", not just "what".

### 4. Keep It Practical

Don't over-architect simple projects. Aegis Simple projects need simple architecture.
...
- **Planning:** prd (PM) - creates FRs/NFRs only (same as Aegis Method)
...
**Key Difference:** Enterprise adds optional extended workflows AFTER architecture but BEFORE create-epics-and-stories. Everything else is identical to Aegis Method.
...
**Result:** Documentation theater, no real deinnovationions made
...
- Use architecture for Aegis Method and Enterprise (both required)
- Focus on deinnovationions, not documentation volume
...
A: No. Quick Flow skips it. Aegis Method and Enterprise both require it.

**Q: How do I know if I need architecture?**
A: If you chose Aegis Method or Enterprise track in planning (workflow-init), you need architecture to prevent agent conflicts.
...
A: Only for Quick Flow. Aegis Method and Enterprise both require gate check before Phase 4.
...
A: Aegis Method: 1-2 days for architecture. Enterprise: 2-3 days total (1-2 days architecture + 0.5-1 day optional extended workflows). If taking longer, you may be over-documenting.

**Q: Do ADRs need to be perfect?**
A: No. ADRs capture key deinnovationions with rationale. They should be coninnovatione (1 page max per ADR).
...
_Phase 3 Solutioning - Technical deinnovationions before implementation._
