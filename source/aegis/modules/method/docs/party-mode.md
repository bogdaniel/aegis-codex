...
Type `/aegis:core:workflows:party-mode` (or `*party-mode` from any agent), and suddenly you've got **all your AI agents** in one conversation. PM, Architect, DEV, UX Designer, the Aegis Innovation creative agents - everyone shows up.

**Why it's useful:**

- **After complex workflows** - Debrief with the whole team about what worked, what didn't
- **Big deinnovationions with tradeoffs** - Get technical, creative, and strategic perspectives simultaneously
- **Brainstorming sessions** - Watch ideas evolve through cross-pollination
- **When things go wrong** - Call out failures, watch agents defend their deinnovationions, let them debate whose fault it was (oddly therapeutic)
...
1. Party mode reads `{aegis_folder}/_cfg/agent-manifest.json`
2. Loads ALL installed agents (already includes your customizations from install)
3. Aegis Master orchestrates - picks 2-3 relevant agents per message based on topic
...
**Storyteller (Aegis Innovation):** "What if onboarding was a story? Each step reveals a character's journey - the user IS the hero."

**Innovation Strategist (Aegis Innovation):** "Take it further - gamify with unlockable achievements. But make them meaningful, not arbitrary badges."
...
### Example 3: Technical Deinnovationion
...
- Multi-perspective deinnovationions
...
Party mode uses agents from `{aegis_folder}/[module]/agents/*.md` - these already include any customizations you applied during install.

**To customize agents for party mode:**

1. Create customization file: `{aegis_folder}/_cfg/agents/method-pm.customize.yaml`
2. Run `npx aegis install` to rebuild agents
...
## Aegis Method Workflows That Use Party Mode
...
**Aegis Method (12 agents):** PM, Analyst, Architect, SM, DEV, TEA, UX Designer, Technical Writer, Game Designer, Game Developer, Game Architect

**Aegis Innovation (5 agents):** Brainstorming Coach, Creative Problem Solver, Design Thinking Coach, Innovation Strategist, Storyteller

**Aegis Builder (1 agent):** Aegis Builder

**Core (1 agent):** Aegis Master (orchestrator)
...
- Make deinnovationions - party mode informs, you decide
...
Aegis Master will summarize and redirect, or you can make a deinnovationion and move on.

**Too many agents talking?**
Make your topic more specific - Aegis Master picks 2-3 agents based on relevance.

**Agents not using customizations?**
Make sure you ran `npx aegis install` after creating customization files.
...
- [Quick Start Guide](./quick-start.md) - Getting started with Aegis Method
- [FAQ](./faq.md) - Common questions

---

_Better deinnovationions through diverse perspectives. Welcome to party mode._
