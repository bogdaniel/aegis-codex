# Aegis Method V6 Quick Start Guide

Get started with Aegis Method v6 for your new greenfield project. This guide walks you through building software from scratch using AI-powered workflows.

## TL;DR - The Quick Path

1. **Install**: `npx aegis@alpha install`
...
## What is Aegis Method?

Aegis Method (Aegis Method) helps you build software through guided workflows with specialized AI agents. The process follows four phases:
...
3. **Phase 3: Solutioning** (Track-dependent) - Design the architecture for Aegis Method and Enterprise tracks
4. **Phase 4: Implementation** (Required) - Build your software Epic by Epic, Story by Story

### Complete Workflow Visualization

![Aegis Method Workflow - Standard Greenfield](./images/workflow-method-greenfield.svg)

_Complete visual flowchart showing all phases, workflows, agents (color-coded), and deinnovationion points for the Aegis Method standard greenfield track. Each box is color-coded by the agent responsible for that workflow._

## Installation

```bash
# Install v6 Alpha to your project
npx aegis@alpha install
```

The interactive installer will guide you through setup and create a `{aegis_folder}/` folder with all agents and workflows.
...
1. **Load the Analyst agent** in your IDE - See your IDE-specific instructions in [docs/ide-info](https://github.com/aegis-code-org/Aegis-METHOD/tree/main/docs/ide-info) for how to activate agents:
   - [Claude Code](https://github.com/aegis-code-org/Aegis-METHOD/blob/main/docs/ide-info/claude-code.md)
   - [VS Code/Cursor/Windsurf](https://github.com/aegis-code-org/Aegis-METHOD/tree/main/docs/ide-info) - Check your IDE folder
...
Workflows are interactive processes in V6 that replaced tasks and templates from prior versions. There are many types of workflows, and you can even create your own with the Aegis Builder module. For the Aegis Method, you'll be interacting with expert-designed workflows crafted to work with you to get the best out of both you and the LLM.
...
- **Aegis Method** - Full planning (PRD + Architecture + UX) - products, platforms, complex features (typically 10-50+ stories)
- **Enterprise Method** - Extended planning (Aegis Method + Security/DevOps/Test) - enterprise requirements, compliance, multi-tenant (typically 30+ stories)

**Note**: Story counts are guidance, not definitions. Tracks are chosen based on planning needs, not story math.

#### What gets created?

Once you confirm your track, the `method-workflow-status.yaml` file will be created in your project's docs folder (assuming default install location). This file tracks your progress through all phases.

**Important notes:**

- Every track has different paths through the phases
- Story counts can still change based on overall complexity as you work
- For this guide, we'll assume a Aegis Method track project
- This workflow will guide you through Phase 1 (optional), Phase 2 (required), and Phase 3 (required for Aegis Method and Enterprise tracks)
...
1. **Start a new chat** with the specified agent (e.g., PM) - See [docs/ide-info](https://github.com/aegis-code-org/Aegis-METHOD/tree/main/docs/ide-info) for your IDE's specific instructions
...
- **PM** → PRD (Aegis Method/Enterprise tracks) OR tech-spec (Quick Flow track)
- **UX-Designer** → UX Design Document (if UI part of the project)
- **Architect** → Architecture (Aegis Method/Enterprise tracks)

#### Phase 2: Planning - Creating the PRD

**For Aegis Method and Enterprise tracks:**
...
3. After completion, you'll have your architecture document with technical deinnovationions
...
**Why after architecture?** Architecture deinnovationions (database, API patterns, tech stack) directly affect how stories should be broken down and sequenced.
...
The agent creates documents, asks questions, and helps you make deinnovationions throughout the process.

## Project Tracking Files

Aegis creates two files to track your progress:

**1. method-workflow-status.yaml**
...
A: Only for Aegis Method and Enterprise tracks. Quick Flow projects skip straight from tech-spec to implementation.
...
- **Complete guide**: [Aegis Method Workflow Documentation](./README.md#-workflow-guides)
- **YouTube tutorials**: [Aegis Code Channel](https://www.youtube.com/@AegisCode)
...
✅ **Track matters** - Quick Flow uses tech-spec, Aegis Method/Enterprise need PRD and architecture
✅ **Tracking is automatic** - The status files update themselves, no manual editing needed
✅ **Agents are flexible** - Use menu numbers, shortcuts (\*prd), or natural language

**Ready to start building?** Install Aegis, load the Analyst, run workflow-init, and let the agents guide you!
