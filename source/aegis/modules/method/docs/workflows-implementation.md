# Aegis Method Implementation Workflows (Phase 4)
...
Phase 4 is the final phase of the Aegis Method workflow. To see how implementation fits into the complete methodology:

The Aegis Method consists of four phases working in sequence:
...
3. **Phase 3 (Solutioning)** - Technical architecture and design deinnovationions
