...
## NFR Gate Deinnovationion Matrix
...
- **Used in workflows**: `*nfr-assess` (automated NFR validation), `*trace` (gate deinnovationion Phase 2), `*test-design` (NFR risk assessment via Utility Tree)
