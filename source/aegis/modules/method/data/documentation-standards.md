# Technical Documentation Standards for Aegis

**For Agent: Technical Writer**
**Purpose: Coninnovatione reference for documentation creation and review**
...
- **flowchart** - Process flows, deinnovationion trees, workflows
...
```mermaid
flowchart TD
    Start[Clear Label] --> Deinnovationion{Question?}
    Deinnovationion -->|Yes| Action1[Do This]
    Deinnovationion -->|No| Action2[Do That]
```
````
...
2. **Aegis conventions** (this document)
...
- Data flow
- Technology deinnovationions (ADRs)
