# Aegis Method Claude Code Sub-Module

## Overview

This sub-module provides Claude Code-specific enhancements for the Aegis Method module, including specialized subagents and content injection for enhanced AI-assisted development workflows.

## How the Installer Works

When Claude Code is selected during Aegis installation:
...
1. Run the Aegis installer
2. Select Aegis Method module and Claude Code
3. Verify prompts appear for subagent selection
4. Check `.claude/agents/` for installed subagents
5. Verify injection points are replaced in `.claude/commands/{aegis_folder}/` and the various tasks and templates under `{aegis_folder}/...`
