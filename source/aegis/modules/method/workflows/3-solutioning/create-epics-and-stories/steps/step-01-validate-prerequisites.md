...
# Path Definitions
workflow_path: '{project-root}/{aegis_folder}/method/workflows/3-solutioning/create-epics-and-stories'
...
# Task References
advancedElicitationTask: '{project-root}/.aegis/core/tasks/advanced-elicitation.xml'
partyModeWorkflow: '{project-root}/.aegis/core/workflows/party-mode/workflow.md'
...
2. **Architecture.md** - Contains technical deinnovationions, API contracts, data models
