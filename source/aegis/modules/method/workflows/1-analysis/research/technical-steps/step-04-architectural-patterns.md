...
- 💬 FOCUS on architectural patterns and design deinnovationions
...
Conduct comprehensive architectural patterns analysis with emphasis on design deinnovationions and implementation approaches for {{research_topic}}.
...
"Now I'll focus on **architectural patterns and design deinnovationions** for effective architecture approaches for [technology/domain].
...
- Note architectural deinnovationion records (ADRs) and rationales
