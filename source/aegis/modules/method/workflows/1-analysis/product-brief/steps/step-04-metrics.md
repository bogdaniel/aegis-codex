...
# Path Definitions
workflow_path: '{project-root}/{aegis_folder}/method/workflows/1-analysis/product-brief'
...
- 📋 COLLABORATIVE metric definition that drives actionable deinnovationions
...
- Limits: Focus on metrics that drive deinnovationions and demonstrate real value creation
...
- Avoid vanity metrics that don't drive deinnovationions
...
- Metrics that don't drive actionable deinnovationions
