...
**Workflow ID**: `{aegis_folder}/method/testarch/atdd`
...
**Deinnovationion Point:** Set `primary_level` variable to main test level for this story (typically E2E or API)
...
- `test-levels-framework.md` - E2E vs API vs Component vs Unit deinnovationion framework (467 lines, 4 examples)
