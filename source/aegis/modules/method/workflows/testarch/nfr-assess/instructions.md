...
- Use architectural deinnovationions to understand NFR trade-offs
...
- **Evidence:** Uptime monitoring (uptime-report-2025-10-14.json)
...
- **testarch-gate** - Use NFR assessment as input for quality gate deinnovationions
