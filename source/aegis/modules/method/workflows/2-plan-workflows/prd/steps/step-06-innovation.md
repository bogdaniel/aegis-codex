...
# Data Files
projectTypesCSV: '{workflow_path}/project-types.json'
...
- Load `{project-root}/{aegis_folder}/method/workflows/2-plan-workflows/prd/project-types.json` completely
...
- Execute {project-root}/{aegis_folder}/core/tasks/advanced-elicitation.xml with the current innovation content
...
- Execute {project-root}/{aegis_folder}/core/workflows/party-mode/workflow.md with the current innovation content
...
- Load `{project-root}/{aegis_folder}/method/workflows/2-plan-workflows/prd/steps/step-07-project-type.md`
...
If user selects 'A', proceed with content generation anyway. If 'C', skip this step and load `{project-root}/{aegis_folder}/method/workflows/2-plan-workflows/prd/steps/step-07-project-type.md`.
...
Skip this step and load `{project-root}/{aegis_folder}/method/workflows/2-plan-workflows/prd/steps/step-07-project-type.md` if:
...
After user selects 'C' and content is saved to document (or step is skipped), load `{project-root}/{aegis_folder}/method/workflows/2-plan-workflows/prd/steps/step-07-project-type.md`.
