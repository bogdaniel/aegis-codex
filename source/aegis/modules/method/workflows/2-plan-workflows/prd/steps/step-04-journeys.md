...
- Execute {project-root}/{aegis_folder}/core/tasks/advanced-elicitation.xml with the current journey content
...
- Execute {project-root}/{aegis_folder}/core/workflows/party-mode/workflow.md with the current journeys
...
- Load `{project-root}/{aegis_folder}/method/workflows/2-plan-workflows/prd/steps/step-05-domain.md` (or determine if step is optional based on domain complexity)
...
❌ Missing critical deinnovationion points and failure scenarios
