...
- Document specific requirements, constraints, and deinnovationions
...
- Execute {project-root}/{aegis_folder}/core/tasks/advanced-elicitation.xml with the current project-type content
...
- Execute {project-root}/{aegis_folder}/core/workflows/party-mode/workflow.md with the current project-type requirements
...
- Load `{project-root}/{aegis_folder}/method/workflows/2-plan-workflows/prd/steps/step-08-scoping.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/{aegis_folder}/method/workflows/2-plan-workflows/prd/steps/step-08-scoping.md` to define project scope.
