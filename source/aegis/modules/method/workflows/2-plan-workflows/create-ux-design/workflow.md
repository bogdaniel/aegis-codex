...
**Goal:** Create comprehensive UX design specifications through collaborative visual exploration and informed deinnovationion-making where you act as a UX facilitator working with a product stakeholder.
...
- `installed_path` = `{project-root}/{aegis_folder}/method/workflows/2-plan-workflows/create-ux-design`
