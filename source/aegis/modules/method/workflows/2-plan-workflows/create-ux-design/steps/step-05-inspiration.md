...
Analyze inspiring products and UX patterns to inform design deinnovationions for the current project.
...
This strategy will guide our design deinnovationions while keeping {{project_name}} unique."
...
- Execute {project-root}/{aegis_folder}/core/tasks/advanced-elicitation.xml with the current inspiration analysis content
...
- Execute {project-root}/{aegis_folder}/core/workflows/party-mode/workflow.md with the current inspiration analysis
