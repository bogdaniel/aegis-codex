...
- What deinnovationions do they need to make?
...
- Deinnovationion points and branches
...
- Reducing cognitive load at each deinnovationion point
...
**Deinnovationion Patterns:**

- [Deinnovationion pattern 1]
- [Deinnovationion pattern 2]
...
- Execute {project-root}/{aegis_folder}/core/tasks/advanced-elicitation.xml with the current user journey content
...
- Execute {project-root}/{aegis_folder}/core/workflows/party-mode/workflow.md with the current user journeys
